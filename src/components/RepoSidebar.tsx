...
type Props = {
  ...
  basePath: string
  repo?: { name: string; branch: string | null; path: string }
}

export type SectionId = 'file-status' | 'history' | 'branches' | 'tags' | 'stashes' | 'settings'

export default function RepoSidebar({ selected, onSelect, basePath, repo }: Props) {
